...
config.participants.users.manufacturers[0].type = 'CUSTOMS';
...
config.participants.users.manufacturers[1].type = 'CUSTOMS';
...
config.participants.users.manufacturers[2].type = 'CUSTOMS';
